...
class Wallet(models.Model):
    ...
    class Meta:
        constraints = [
            models.CheckConstraint(condition=models.Q(balance__gte=0), name="wallet_balance_gte_zero")
        ]
...
class WalletTransaction(models.Model):
    ...
    class Meta:
        ordering = ["-created_at"]
        constraints = [
            models.CheckConstraint(condition=models.Q(amount__gt=0), name="wallet_transaction_amount_gt_zero")
        ]
